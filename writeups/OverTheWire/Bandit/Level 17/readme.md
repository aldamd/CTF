...
```shell
bandit16@bandit:~$ nmap -sV -p31000-32000 -T5 localhost
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-10-18 15:57 UTC
...
SF-Port31790-TCP:V=7.94SVN%T=SSL%I=7%D=10/18%Time=67128597%P=x86_64-pc-lin
