- Python #shellcode challenge that required you to spawn a shell but checked for `syscall` or `int 80` instructions
	- Required us to misalign the instruction and add a jmp instruction past our misalignment
### challenge
```python
import sys
import mmap
